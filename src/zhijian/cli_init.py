...
def detect_domain(project_path: Path) -> Tuple[str, List[str], float]:
    ...
    from zhijian.config import DOMAIN_PROFILES
...
def _collect_python_complexity_candidates(project_path: Path) -> List[Dict[str, Any]]:
    ...
    from zhijian.patterns.python_complexity import _cyclomatic_complexity
...
def _get_init_baseline_ignore_patterns(project_type: str, domain_path: str) -> set:
    ...
    from zhijian.config import DOMAIN_PROFILES, Config
...
def _run_init(args: argparse.Namespace) -> int:
    ...
    from zhijian.config import DOMAIN_PROFILES, generate_slopconfig_template
