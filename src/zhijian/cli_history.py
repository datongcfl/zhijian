...
def _check_calibration_hint(args) -> None:
    ...
    try:
        ...
        from zhijian.history import HistoryTracker
        from zhijian.ml.self_calibrator import CALIBRATION_MILESTONE, SelfCalibrator
...
def _run_self_calibration(args: argparse.Namespace) -> int:
    ...
    from zhijian.config import Config
    from zhijian.ml.self_calibrator import SelfCalibrator
