...
from zhijian.cli_analysis import (
...
def run_impact_command(argv: list[str]) -> int:
    ...
    from zhijian.impact import ImpactTracker
...
def run_telemetry_command(argv: list[str]) -> int:
    ...
    from zhijian.telemetry import TelemetryManager
...
def run_operations_command(
    ...
    *,
    ...
    if command == "explain":
        from zhijian.operations import build_explain_payload
    ...
    if command == "audit":
        from zhijian.operations import build_audit_payload
    ...
    if command == "health":
        from zhijian.operations import build_health_payload
    ...
    if command in {
        ...
        from zhijian.operations import build_cleanup_payload
    ...
    if command == "watch":
        from zhijian.operations import build_health_payload, watch_project
