...
class MLPipeline:
    ...
    def run_on_real_data(
        ...
        """
        from zhijian.ml.dataset_loader import DatasetLoader
    ...
    def _train_from_dataset(
        ...
        from zhijian.ml.classifier import SlopClassifier
    ...
    def _generate_samples(self, n_slop: int, n_clean: int) -> List[TrainingSample]:
        from zhijian.ml.synthetic_generator import SyntheticGenerator
