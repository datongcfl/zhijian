...
from zhijian import __version__


def _build_arg_parser() -> argparse.ArgumentParser:
    """Build and return the CLI argument parser."""
    parser = argparse.ArgumentParser(
        description=f"智检 (Zhijian) v{__version__} - AI 代码质量检测工具",
...
Examples:
  ...
  zhijian --version                    # 显示版本
    ...
    parser.add_argument("--version", action="version", version=f"zhijian {__version__}")
    parser.add_argument(
