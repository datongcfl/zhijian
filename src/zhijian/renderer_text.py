...
from zhijian.renderer_glossary import (
    DEFICIT_BANDS,
    coherence_display,
    file_metric_rows,
    next_steps,
...
from zhijian.renderer_markdown import _collect_test_evidence_stats
...
def _text_project_section(result) -> list:
    ...
    if coh:
        lines += [
            ...
            f"  Score: {coh['value']} ({coh['direction']} is more cohesive)",
