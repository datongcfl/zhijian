...
def _emit_command_payload(args, payload: dict) -> int:
    ...
    if getattr(args, "json", False):
        ...
        from zhijian.operations import render_payload_markdown, render_payload_text
...
def _route_file_output(out: str, result, rich_ok: bool) -> None:
    ...
    from zhijian.cli_renderer import (
...
def _handle_output(args, result) -> None:
    ...
    from zhijian.cli_renderer import RICH_AVAILABLE
