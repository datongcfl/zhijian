...
from zhijian.metrics.context_jargon import ContextJargonResult, JargonEvidence
from zhijian.metrics.docstring_inflation import (
    DocstringInflationDetail,
    DocstringInflationResult,
)
from zhijian.metrics.hallucination_deps import (
    CategoryUsage,
...
def _restore_ml_score(data: Optional[Dict[str, Any]]) -> Any:
    if not data:
        return None
    from zhijian.ml.scorer import MLScore
