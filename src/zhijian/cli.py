...
from zhijian.core import SlopDetector  # re-exported for CLI patch surface/tests
from zhijian.leda_injection import build_leda_injection, write_leda_injection
...
def _build_arg_parser():
    from zhijian.cli_parsers import _build_arg_parser as _impl

    return _impl()


def _normalize_format_args(args) -> None:
    from zhijian.cli_parsers import _normalize_format_args as _impl

    _impl(args)


def _apply_runtime_overrides(args, detector) -> None:
    from zhijian.cli_analysis import _apply_runtime_overrides as _impl

    _impl(args, detector)


def _run_analysis_phase(args, detector):
    from zhijian.cli_analysis import _run_analysis_phase as _impl

    return _impl(args, detector)


def _record_optional_impact(command_name: str, result) -> None:
    from zhijian.cli_observability import _record_optional_impact as _impl

    _impl(command_name, result)


def _capture_optional_telemetry(command_name: str, result) -> None:
    from zhijian.cli_observability import _capture_optional_telemetry as _impl

    _impl(command_name, result)


def _handle_output(args, result) -> None:
    from zhijian.cli_output import _handle_output as _impl

    _impl(args, result)


def generate_html_report(*args, **kwargs):
    from zhijian.cli_renderer import generate_html_report as _impl

    return _impl(*args, **kwargs)


def generate_markdown_report(*args, **kwargs):
    from zhijian.cli_renderer import generate_markdown_report as _impl

    return _impl(*args, **kwargs)


def generate_text_report(*args, **kwargs):
    from zhijian.cli_renderer import generate_text_report as _impl

    return _impl(*args, **kwargs)


def get_mitigation(*args, **kwargs):
    from zhijian.cli_renderer import get_mitigation as _impl

    return _impl(*args, **kwargs)


def list_patterns(*args, **kwargs):
    from zhijian.cli_renderer import list_patterns as _impl

    return _impl(*args, **kwargs)


def print_rich_report(*args, **kwargs):
    from zhijian.cli_renderer import print_rich_report as _impl

    return _impl(*args, **kwargs)


def _check_calibration_hint(*args, **kwargs):
    from zhijian.cli_commands import _check_calibration_hint as _impl

    return _impl(*args, **kwargs)


def _export_history(*args, **kwargs):
    from zhijian.cli_commands import _export_history as _impl

    return _impl(*args, **kwargs)


def _get_git_context(*args, **kwargs):
    from zhijian.cli_commands import _get_git_context as _impl

    return _impl(*args, **kwargs)


def _record_history(*args, **kwargs):
    from zhijian.cli_commands import _record_history as _impl

    return _impl(*args, **kwargs)


def _run_init(*args, **kwargs):
    from zhijian.cli_commands import _run_init as _impl

    return _impl(*args, **kwargs)


def _run_self_calibration(*args, **kwargs):
    from zhijian.cli_commands import _run_self_calibration as _impl

    return _impl(*args, **kwargs)


def _run_verify_governance(*args, **kwargs):
    from zhijian.cli_commands import _run_verify_governance as _impl

    return _impl(*args, **kwargs)


def _show_file_history(*args, **kwargs):
    from zhijian.cli_commands import _show_file_history as _impl

    return _impl(*args, **kwargs)


def _show_trends(*args, **kwargs):
    from zhijian.cli_commands import _show_trends as _impl
...
def _run_impact_command(argv: list[str]) -> int:
    ...
    from zhijian.cli_handlers import run_impact_command as _impl
...
def _run_telemetry_command(argv: list[str]) -> int:
    ...
    from zhijian.cli_handlers import run_telemetry_command as _impl
...
def _run_operations_command(command: str, argv: list[str]) -> int:
    ...
    from zhijian.cli_handlers import run_operations_command as _impl
...
def _run_sweep_command(argv: list[str]) -> int:
    ...
    from zhijian.cli_handlers import run_sweep_command as _impl
...
def _evaluate_ci_gate(args, result):
    ...
    from zhijian.cli_handlers import evaluate_ci_gate as _impl
...
def _run_optional_features(args, result) -> None:
    ...
    from zhijian.cli_handlers import run_optional_features as _impl
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    if argv_list and argv_list[0] == "verify-governance":
        verify_parser = argparse.ArgumentParser(
            prog="zhijian verify-governance",
